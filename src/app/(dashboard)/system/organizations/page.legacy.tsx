...
import { Building2, Search, Users, BookOpen, Award, Plus } from "lucide-react";
...
export default function SystemOrganizationsPageLegacy() {
                  ...
                  <tr key={org.id} className="hover:bg-muted/30 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <span className="font-medium text-foreground">{org.name ?? "(no name)"}</span>
                          <p className="text-xs text-muted-foreground font-mono">{org.slug ?? org.id}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2 text-muted-foreground">
                        ...
                        {org.certificates_count ?? 0}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                          org.is_active === false ? "bg-gray-100 text-gray-800" : "bg-green-100 text-green-800"
                        }`}
                      >
